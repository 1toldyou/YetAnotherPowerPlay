...
public class
ConeVomitMidCommand extends SequentialCommandGroup {
    public ConeVomitMidCommand(Robot robot, Consumer<Boolean> busy) {
        super(
                new SequentialCommandGroup(
                        ...
                        new ParallelCommandGroup(
                                ...
                                new SequentialCommandGroup(
                                        ...
                                        new IntakePositionCommand(robot.intake, 465, 4000, 4000, 20, 3000, IntakeSubsystem.STATE.FAILED_EXTEND)
                                ...
                                new SequentialCommandGroup(
                                        ...
                                        new LiftPositionCommand(robot.lift, 340, 6000, 7500, 40, 3000, LiftSubsystem.STATE.FAILED_EXTEND),
                                        new WaitCommand(50),
